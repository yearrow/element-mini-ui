...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'element-mini-ui/src/utils/date-util';
  import ElScrollbar from 'element-mini-ui/packages/scrollbar';
  import RepeatClick from 'element-mini-ui/src/directives/repeat-click';
