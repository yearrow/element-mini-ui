...
<script>
import Popper from 'element-mini-ui/src/utils/vue-popper';
import Clickoutside from 'element-mini-ui/src/utils/clickoutside';
import Emitter from 'element-mini-ui/src/mixins/emitter';
import Locale from 'element-mini-ui/src/mixins/locale';
import Migrating from 'element-mini-ui/src/mixins/migrating';
import ElInput from 'element-mini-ui/packages/input';
import ElTag from 'element-mini-ui/packages/tag';
import ElScrollbar from 'element-mini-ui/packages/scrollbar';
import ElCascaderPanel from 'element-mini-ui/packages/cascader-panel';
import AriaUtils from 'element-mini-ui/src/utils/aria-utils';
import { t } from 'element-mini-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from 'element-mini-ui/src/utils/util';
import { isUndefined, isFunction } from 'element-mini-ui/src/utils/types';
import { isDef } from 'element-mini-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'element-mini-ui/src/utils/resize-event';
